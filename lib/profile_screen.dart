...
class ProfileScreenState extends State<ProfileScreen> {
    ...
    return new FutureBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        ...
        return new Container(
          ...
          // child: new Center(child: new Stack( children: <Widget>[
          //   // new Image.network(user.image),
  ...
  Widget build(BuildContext context){
    return new scopedModel.ScopedModel<AppModel>(
      model : new AppModel(),
      child: new SingleChildScrollView( // TODO Profile screen Futurebiulder 
        child: new Center(
          child: new Column(
            children: <Widget>[
